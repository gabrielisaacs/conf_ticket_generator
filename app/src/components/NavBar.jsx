...
const NavBar = () => {
  return (
    <
      ...
      <div className="grid grid-cols-3 grid-rows-1 items-center gap-[5.5rem]">
        <a href="#" className='mr-auto'>
          <img src="/logo.svg" alt="logo" className='h-full w-auto' />
        </a>
        <div className="flex flex-row text-[1rem] text-[#fff] gap-6 text-center mx-auto">
        ...
        <a href="#" className='ml-auto'>
          <button className='inline-flex px-[1.5rem] h-[3.25rem] text-[#0A0C11] hover:text-white bg-white hover:bg-[#24A0B5] justify-center items-center rounded-xl border border-[#D9D9D9] gap-1 text-[1rem] font-extrabold group transition-all duration-300 navBtn'>
            MY TICKETS

      ...
      <div className="w-full h-max-content bg-[#08252B] border border-[#0E464F] rounded-[2rem] p-[1.5rem]">
        ...
        <div className="flex flex-row gap-[1.5rem] w-full">
          <a href="#" className='w-full'>
            <button className='w-full h-[3.25rem] hover:bg-[#24A0B5]/20 justify-center rounded-xl border border-[#24A0B5] text-[#24A0B5] text-[1rem] text-center transition-all duration-300 disabled:bg-transparent'>
              Back
            </button>
          </a>
          <a href="#" className='w-full'>
